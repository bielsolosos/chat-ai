    ...
    <div class="drawer drawer-end bg-base-100 h-screen" [class.lg:drawer-open]="isSidebarOpen()">
      ...
      <div class="drawer-content flex flex-col h-full overflow-hidden">
        ...
        <div class="navbar bg-base-100 border-b border-base-200 shrink-0 px-4 flex justify-between">
          <div class="flex-1">
            <span class="text-xl font-semibold tracking-tight text-base-content"
              >Assistente IA</span
            >
          </div>
        ...
        <div class="flex-1 overflow-y-auto px-4 py-8" #chatContainer>
          <div class="max-w-4xl mx-auto flex flex-col gap-6">
            @if (messages().length === 0) {
              <div
                class="flex flex-col items-center justify-center h-full min-h-[40vh] text-center opacity-40"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <div class="drawer-side z-10">
        ...
        <ul
          class="menu p-4 w-80 min-h-full bg-base-200 text-base-content border-l border-base-300 flex flex-col justify-between"
        >
          <div>
            <li>
              <button
                class="btn btn-ghost border border-base-content/20 justify-start shadow-sm mb-4 rounded-xl"
                (click)="newChat()"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        error: (err) => {
          ...
          this.messages.update((prev) => [
            ...prev,
            {
              role: 'bot',
              content:
                'Ops! Ocorreu um erro ao comunicar com a inteligência artificial. O backend parece estar indisponível ou ocorreu um timeout.',
            },
          ]);
        },
      });
